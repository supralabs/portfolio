    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              Saya seorang siswa SMKN 2 Trenggalek dari jurusan Rekayasa Perangkat Lunak (RPL). Hobi saya bermain catur dan sepak bola, Dan saya sudah pernah mempelajari beberapa bahasa pemrograman di sekolah seperti HTML, CSS, PHP, dan Kotlin.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Tiada kata terlambat untuk belajar selagi memiliki kemauan."
        </blockquote>
      </div>
